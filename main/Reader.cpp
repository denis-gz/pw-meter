...
{
    if (disposing) {
        adc_continuous_deinit(m_adc_handle), m_adc_handle = nullptr;
        adc_cali_delete_scheme_curve_fitting(m_adc_v_cali_handle), m_adc_v_cali_handle = nullptr;
        adc_cali_delete_scheme_curve_fitting(m_adc_i_cali_handle), m_adc_i_cali_handle = nullptr;
    }
    else {
